...
public class ExplorationRoutine : IMovementRoutine
{
    ...
    public List<Coordinate> GetAdjacentFreeCoordinates(SimulationContext context)
    {
        ...
        if(context.Rover.Position.Y - 1 >= 0 && (mapRepresentation[context.Rover.Position.Y-1, context.Rover.Position.X] == "" || mapRepresentation[context.Rover.Position.Y-1, context.Rover.Position.X] == null))
        {
        ...
        if (context.Rover.Position.X - 1 >= 0 && (mapRepresentation[context.Rover.Position.Y, context.Rover.Position.X - 1] == "" || mapRepresentation[context.Rover.Position.Y, context.Rover.Position.X - 1] == null))
        {
